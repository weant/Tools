...
public class PMP {
	...
	private EmlAttributes.PMP.SnmpPmDomain domain;
	...
	private PMP(int groupID, int neID, String neName, String ptpName,
			String ftpName, String ctpName, EmlAttributes.PMP.SnmpPmDomain domain,
	...
	public PMP(int groupID, int neID, String neName, EmlAttributes.PMP.SnmpPmDomain domain,
			String tableOid, int ifIndex, String pmpName, short layerRate,
			Location location, Direction direction, Granularity granularity) {
	...
	public EmlAttributes.PMP.SnmpPmDomain getDomain() {
		return domain;
	}
